...
int main()
{
    ...
    int q = 2;
    if (q>0) {
        printf("Число положительное");//если число положительное, то выводиться данное сообщение
    }
    else {
        printf("Число неположительное");//данное сообщение выводится, если число неположительное
    }
